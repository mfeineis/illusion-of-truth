...
var _user$project$Main$debugFlags = {
	providers: {
		ctor: '::',
...
var _user$project$Main$reactor = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init(_user$project$Main$debugFlags),
...
var _user$project$Main$Provider = function (a) {
	return {rss: a};
};
var _user$project$Main$ProgramFlags = function (a) {
	return {providers: a};
};
