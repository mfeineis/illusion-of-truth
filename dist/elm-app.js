...
var _mfeineis$the_illusion_of_truth$Util_ops = _mfeineis$the_illusion_of_truth$Util_ops || {};
_mfeineis$the_illusion_of_truth$Util_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});

var _mfeineis$the_illusion_of_truth$Data_User$User = {};

var _mfeineis$the_illusion_of_truth$Data_Session$Session = function (a) {
	return {user: a};
};

var _mfeineis$the_illusion_of_truth$Route$routeToString = function (page) {
	var pieces = function () {
		var _p0 = page;
		return {ctor: '[]'};
	}();
...
var _mfeineis$the_illusion_of_truth$Route$href = function (route) {
	return _elm_lang$html$Html_Attributes$href(
		_mfeineis$the_illusion_of_truth$Route$routeToString(route));
};
var _mfeineis$the_illusion_of_truth$Route$modifyUrl = function (_p1) {
	return _elm_lang$navigation$Navigation$modifyUrl(
		_mfeineis$the_illusion_of_truth$Route$routeToString(_p1));
};
var _mfeineis$the_illusion_of_truth$Route$Home = {ctor: 'Home'};
var _mfeineis$the_illusion_of_truth$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_mfeineis$the_illusion_of_truth$Route$Home,
			_evancz$url_parser$UrlParser$s('')),
		_1: {ctor: '[]'}
	});
var _mfeineis$the_illusion_of_truth$Route$fromLocation = function (location) {
	return _elm_lang$core$String$isEmpty(location.hash) ? _elm_lang$core$Maybe$Just(_mfeineis$the_illusion_of_truth$Route$Home) : A2(_evancz$url_parser$UrlParser$parseHash, _mfeineis$the_illusion_of_truth$Route$route, location);
};

var _mfeineis$the_illusion_of_truth$Views_Spinner$spinner = A2(
	_elm_lang$html$Html$li,
	{
		...
		_1: {
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_mfeineis$the_illusion_of_truth$Util_ops['=>'], 'float', 'left'),
					_1: {
						ctor: '::',
						_0: A2(_mfeineis$the_illusion_of_truth$Util_ops['=>'], 'margin', '8px'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _mfeineis$the_illusion_of_truth$Views_Page$bodyId = 'page-body';
var _mfeineis$the_illusion_of_truth$Views_Page$viewFooter = A2(
...
var _mfeineis$the_illusion_of_truth$Views_Page$viewHeader = F3(
...
var _mfeineis$the_illusion_of_truth$Views_Page$frame = F4(
	function (isLoading, user, page, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_mfeineis$the_illusion_of_truth$Views_Page$viewHeader, page, user, isLoading),
				_1: {
					ctor: '::',
					_0: content,
					_1: {
						ctor: '::',
						_0: _mfeineis$the_illusion_of_truth$Views_Page$viewFooter,
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _mfeineis$the_illusion_of_truth$Views_Page$Home = {ctor: 'Home'};
var _mfeineis$the_illusion_of_truth$Views_Page$Other = {ctor: 'Other'};

var _mfeineis$the_illusion_of_truth$Page_Errored$view = F2(
...
var _mfeineis$the_illusion_of_truth$Page_Errored$Model = F2(
	function (a, b) {
		return {activePage: a, errorMessage: b};
	});
var _mfeineis$the_illusion_of_truth$Page_Errored$PageLoadError = function (a) {
	return {ctor: 'PageLoadError', _0: a};
};
var _mfeineis$the_illusion_of_truth$Page_Errored$pageLoadError = F2(
	function (activePage, errorMessage) {
		return _mfeineis$the_illusion_of_truth$Page_Errored$PageLoadError(
			{activePage: activePage, errorMessage: errorMessage});
	});

var _mfeineis$the_illusion_of_truth$Page_Home$update = F3(
	function (session, msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _mfeineis$the_illusion_of_truth$Page_Home$view = F2(
	function (session, model) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Homepage content'),
				_1: {ctor: '[]'}
			});
	});
var _mfeineis$the_illusion_of_truth$Page_Home$Model = function (a) {
	return {fake: a};
};
var _mfeineis$the_illusion_of_truth$Page_Home$init = function (session) {
	var handleLoadError = function (_p0) {
		return A2(_mfeineis$the_illusion_of_truth$Page_Errored$pageLoadError, _mfeineis$the_illusion_of_truth$Views_Page$Home, 'Homepage is currently unavailable.');
	};
	var loadFake = _elm_lang$core$Task$succeed(true);
	return A2(
		_elm_lang$core$Task$mapError,
		handleLoadError,
		A2(_elm_lang$core$Task$map, _mfeineis$the_illusion_of_truth$Page_Home$Model, loadFake));
};
var _mfeineis$the_illusion_of_truth$Page_Home$NoOp = {ctor: 'NoOp'};

var _mfeineis$the_illusion_of_truth$Page_NotFound$view = function (session) {
	return A2(
		_elm_lang$html$Html$main_,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Not Found content'),
			_1: {ctor: '[]'}
		});
};

var _mfeineis$the_illusion_of_truth$Main$getPage = function (pageState) {
	var _p0 = pageState;
	if (_p0.ctor === 'Loaded') {
		return _p0._0;
	} else {
...
var _mfeineis$the_illusion_of_truth$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _mfeineis$the_illusion_of_truth$Main$debugFlags = {
	providers: {
		ctor: '::',
		_0: {rss: 'http://www.tagesschau.de/xml/rss2'},
		_1: {
			ctor: '::',
			_0: {rss: 'http://www.spiegel.de/schlagzeilen/tops/index.rss'},
			_1: {
				ctor: '::',
				_0: {rss: 'http://rss.cnn.com/rss/cnn_latest.rss'},
				_1: {
					ctor: '::',
					_0: {rss: 'http://www.aljazeera.com/xml/rss/all.xml'},
					_1: {ctor: '[]'}
				}
			}
		}
...
var _mfeineis$the_illusion_of_truth$Main$Provider = function (a) {
	return {rss: a};
};
var _mfeineis$the_illusion_of_truth$Main$ProgramFlags = function (a) {
	return {providers: a};
};
var _mfeineis$the_illusion_of_truth$Main$Model = F2(
	function (a, b) {
		return {pageState: a, session: b};
	});
var _mfeineis$the_illusion_of_truth$Main$HomeMsg = function (a) {
	return {ctor: 'HomeMsg', _0: a};
};
var _mfeineis$the_illusion_of_truth$Main$viewPage = F3(
	function (session, isLoading, page) {
		var frame = A2(_mfeineis$the_illusion_of_truth$Views_Page$frame, isLoading, session.user);
		var _p1 = page;
		switch (_p1.ctor) {
			case 'NotFound':
				return A2(
					frame,
					_mfeineis$the_illusion_of_truth$Views_Page$Other,
					_mfeineis$the_illusion_of_truth$Page_NotFound$view(session));
			case 'Blank':
				return A2(
					frame,
					_mfeineis$the_illusion_of_truth$Views_Page$Other,
			...
			case 'Errored':
				return A2(
					frame,
					_mfeineis$the_illusion_of_truth$Views_Page$Other,
					A2(_mfeineis$the_illusion_of_truth$Page_Errored$view, session, _p1._0));
			default:
				return A2(
					_elm_lang$html$Html$map,
					_mfeineis$the_illusion_of_truth$Main$HomeMsg,
					A2(
						frame,
						_mfeineis$the_illusion_of_truth$Views_Page$Home,
						A2(_mfeineis$the_illusion_of_truth$Page_Home$view, session, _p1._0)));
		}
	});
var _mfeineis$the_illusion_of_truth$Main$view = function (model) {
	var _p2 = model.pageState;
	if (_p2.ctor === 'Loaded') {
		return A3(_mfeineis$the_illusion_of_truth$Main$viewPage, model.session, false, _p2._0);
	} else {
		return A3(_mfeineis$the_illusion_of_truth$Main$viewPage, model.session, true, _p2._0);
	}
};
var _mfeineis$the_illusion_of_truth$Main$HomeLoaded = function (a) {
	return {ctor: 'HomeLoaded', _0: a};
};
var _mfeineis$the_illusion_of_truth$Main$SetRoute = function (a) {
	return {ctor: 'SetRoute', _0: a};
};
var _mfeineis$the_illusion_of_truth$Main$Home = function (a) {
	return {ctor: 'Home', _0: a};
};
var _mfeineis$the_illusion_of_truth$Main$Errored = function (a) {
	return {ctor: 'Errored', _0: a};
};
var _mfeineis$the_illusion_of_truth$Main$NotFound = {ctor: 'NotFound'};
var _mfeineis$the_illusion_of_truth$Main$Blank = {ctor: 'Blank'};
var _mfeineis$the_illusion_of_truth$Main$initialPage = _mfeineis$the_illusion_of_truth$Main$Blank;
var _mfeineis$the_illusion_of_truth$Main$TransitioningFrom = function (a) {
	return {ctor: 'TransitioningFrom', _0: a};
};
var _mfeineis$the_illusion_of_truth$Main$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _mfeineis$the_illusion_of_truth$Main$pageErrored = F3(
	function (model, activePage, errorMessage) {
		var error = A2(_mfeineis$the_illusion_of_truth$Page_Errored$pageLoadError, activePage, errorMessage);
		return A2(
			_mfeineis$the_illusion_of_truth$Util_ops['=>'],
			_elm_lang$core$Native_Utils.update(
				model,
				{
					pageState: _mfeineis$the_illusion_of_truth$Main$Loaded(
						_mfeineis$the_illusion_of_truth$Main$Errored(error))
				}),
			_elm_lang$core$Platform_Cmd$none);
	});
var _mfeineis$the_illusion_of_truth$Main$setRoute = F2(
	function (maybeRoute, model) {
		var errored = _mfeineis$the_illusion_of_truth$Main$pageErrored(model);
		var transition = F2(
			function (toMsg, task) {
				return A2(
					_mfeineis$the_illusion_of_truth$Util_ops['=>'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							pageState: _mfeineis$the_illusion_of_truth$Main$TransitioningFrom(
								_mfeineis$the_illusion_of_truth$Main$getPage(model.pageState))
						}),
		...
		if (_p3.ctor === 'Nothing') {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						pageState: _mfeineis$the_illusion_of_truth$Main$Loaded(_mfeineis$the_illusion_of_truth$Main$NotFound)
					}),
				_elm_lang$core$Platform_Cmd$none);
		} else {
			return A2(
				transition,
				_mfeineis$the_illusion_of_truth$Main$HomeLoaded,
				_mfeineis$the_illusion_of_truth$Page_Home$init(model.session));
		}
	});
var _mfeineis$the_illusion_of_truth$Main$init = F2(
	function (flags, location) {
		return A2(
			_mfeineis$the_illusion_of_truth$Main$setRoute,
			_mfeineis$the_illusion_of_truth$Route$fromLocation(location),
			{
				pageState: _mfeineis$the_illusion_of_truth$Main$Loaded(_mfeineis$the_illusion_of_truth$Main$initialPage),
				session: {user: _elm_lang$core$Maybe$Nothing}
			});
	});
var _mfeineis$the_illusion_of_truth$Main$updatePage = F3(
	function (page, msg, model) {
		...
		switch (_p5._0.ctor) {
			case 'SetRoute':
				return A2(_mfeineis$the_illusion_of_truth$Main$setRoute, _p5._0._0, model);
			case 'HomeLoaded':
				if (_p5._0._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _mfeineis$the_illusion_of_truth$Main$Loaded(
									_mfeineis$the_illusion_of_truth$Main$Home(_p5._0._0._0))
							}),
						_elm_lang$core$Platform_Cmd$none);
				} else {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _mfeineis$the_illusion_of_truth$Main$Loaded(
									_mfeineis$the_illusion_of_truth$Main$Errored(_p5._0._0._0))
							}),
						_elm_lang$core$Platform_Cmd$none);
				}
			default:
				switch (_p5._1.ctor) {
					case 'Home':
						return A5(
							toPage,
							_mfeineis$the_illusion_of_truth$Main$Home,
							_mfeineis$the_illusion_of_truth$Main$HomeMsg,
							_mfeineis$the_illusion_of_truth$Page_Home$update(session),
							_p5._0._0,
							_p5._1._0);
					case 'NotFound':
						return A2(_mfeineis$the_illusion_of_truth$Util_ops['=>'], model, _elm_lang$core$Platform_Cmd$none);
					default:
						return A2(_mfeineis$the_illusion_of_truth$Util_ops['=>'], model, _elm_lang$core$Platform_Cmd$none);
				}
		}
	});
var _mfeineis$the_illusion_of_truth$Main$update = F2(
	function (msg, model) {
		return A3(
			_mfeineis$the_illusion_of_truth$Main$updatePage,
			_mfeineis$the_illusion_of_truth$Main$getPage(model.pageState),
			msg,
			model);
	});
var _mfeineis$the_illusion_of_truth$Main$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	function (_p6) {
		return _mfeineis$the_illusion_of_truth$Main$SetRoute(
			_mfeineis$the_illusion_of_truth$Route$fromLocation(_p6));
	},
	{init: _mfeineis$the_illusion_of_truth$Main$init, subscriptions: _mfeineis$the_illusion_of_truth$Main$subscriptions, update: _mfeineis$the_illusion_of_truth$Main$update, view: _mfeineis$the_illusion_of_truth$Main$view})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (providers) {
		...
		A2(
			...
			_elm_lang$core$Json_Decode$list(
				A2(
					...
					A2(_elm_lang$core$Json_Decode$field, 'rss', _elm_lang$core$Json_Decode$string))))));
var _mfeineis$the_illusion_of_truth$Main$reactor = A2(
	_elm_lang$navigation$Navigation$program,
	function (_p7) {
		return _mfeineis$the_illusion_of_truth$Main$SetRoute(
			_mfeineis$the_illusion_of_truth$Route$fromLocation(_p7));
	},
	{
		init: _mfeineis$the_illusion_of_truth$Main$init(_mfeineis$the_illusion_of_truth$Main$debugFlags),
		subscriptions: _mfeineis$the_illusion_of_truth$Main$subscriptions,
		update: _mfeineis$the_illusion_of_truth$Main$update,
		view: _mfeineis$the_illusion_of_truth$Main$view
	});

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mfeineis$the_illusion_of_truth$Main$main !== 'undefined') {
    _mfeineis$the_illusion_of_truth$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{"Page.Errored.Model":{"type":"{ activePage : Views.Page.ActivePage, errorMessage : String }","args":[]},"Page.Home.Model":{"type":"{ fake : Bool }","args":[]}},"unions":{"Main.Msg":{"tags":{"HomeLoaded":["Result.Result Page.Errored.PageLoadError Page.Home.Model"],"SetRoute":["Maybe.Maybe Route.Route"],"HomeMsg":["Page.Home.Msg"]},"args":[]},"Page.Errored.PageLoadError":{"tags":{"PageLoadError":["Page.Errored.Model"]},"args":[]},"Views.Page.ActivePage":{"tags":{"Other":[],"Home":[]},"args":[]},"Page.Home.Msg":{"tags":{"NoOp":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Maybe.Maybe":{"tags":{"Nothing":[],"Just":["a"]},"args":["a"]},"Route.Route":{"tags":{"Home":[]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
